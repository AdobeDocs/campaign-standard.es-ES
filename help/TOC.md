...
+ Canales de comunicación {#communication-channels}
  ...
  + Correo directo {#direct-mail}
    ...
    + [Definición del público de correo directo](channels/using/defining-the-direct-mail-audience.md)
...
+ Diseño del contenido de correo electrónico {#designing-content}
...
+ Integración con otras soluciones {#integrating-with-adobe-cloud}
  ...
  + Campaign y Microsoft Dynamics 365 {#campaign-and-microsoft-dynamics-365}
    ...
    + Configuración de la aplicación de integración {#configure-integration-tool}
      ...
      + [Migración de credenciales de JWT a OAuth de servidor a servidor](integrating/using/d365-acs-self-service-app-migrate-credentials.md)
...
+ Administración de procesos y datos {#managing-processes-and-data}
  ...
  + Actividades del canal {#channel-activities}
...
+ Administración {#administrating}
  ...
  + Configuración de canales {#configuring-channels}
    ...
    + {hide-from-toc}[Guía de la CNIL sobre píxeles de seguimiento de correo electrónico](administration/using/cnil-pixel-tracking.md)
...
+ Uso de las API {#working-with-apis}
  ...
  + Administración de unidades organizativas {#managing-organizational-units}
