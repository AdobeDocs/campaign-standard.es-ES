...
1. Edite el contenido del mensaje y defina las opciones avanzadas. Consulte [Personalización de un mensaje en la aplicación](https://helpx.adobe.com/es/campaign/standard/channels/using/customizing-a-push-notification.html).
