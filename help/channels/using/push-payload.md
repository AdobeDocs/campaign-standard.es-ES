...
* Aplicaciones iOS: **Administración de notificaciones** remotas en Notificaciones [](https://developer.apple.com/library/archive/documentation/NetworkingInternet/Conceptual/RemoteNotificationsPG/HandlingRemoteNotifications.html)remotas.
