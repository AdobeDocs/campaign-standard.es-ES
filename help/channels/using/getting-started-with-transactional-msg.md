...
* No son compatibles con [reglas de fatiga](../../sending/using/fatigue-rules.md) (incluso en el caso de un enriquecimiento con perfiles).
...
* Tenga en cuenta que este paso debe realizarlo un usuario con [derechos de administración](../../administration/using/users-management.md#functional-administrators).
...
* Este paso lo puede llevar a cabo cualquier usuario de mercadotecnia con [derechos de acceso de usuario estándar](../../administration/using/users-management.md#basic-users).

Para obtener más información sobre la edición y publicación de un mensaje transaccional, consulte [mensajes transaccionales de Evento](../../channels/using/event-transactional-messages.md).
...
Para obtener más información sobre la integración del evento en su sitio Web, consulte [Integración del sitio](../../administration/using/configuring-transactional-messaging.md#integrating-the-triggering-of-the-event-in-a-website).
