...
Una vez realizadas las pruebas correctamente, puede publicar la página de aterrizaje mediante el **[!UICONTROL Publish]** botón de la barra de acciones del tablero. Un bloque de monitoreo muestra la progresión y el estado de la publicación.
