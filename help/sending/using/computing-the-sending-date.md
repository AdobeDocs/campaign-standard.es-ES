...
1. Arrastre y suelte una actividad **Query** en el flujo de trabajo y ábrala. Consulte la sección [Query](../../automating/using/query.md).
...
1. Defina cinco segmentos. Para cada segmento:
   ...
   * Rellene el campo **[!UICONTROL Segment code]**: introduzca manualmente la fecha y hora deseadas para enviar el mensaje.
   ...
   * Asegúrese de seleccionar la opción **[!UICONTROL Limit the population of this segment]** .
      ...
      En la pestaña **[!UICONTROL Limitation]** , seleccione **[!UICONTROL Random sampling]** e introduzca el porcentaje deseado para cada segmento: 10 para el primer lote, 15 para el segundo, etc.
...
1. Arrastre y suelte una actividad **Email delivery** en el flujo de trabajo y ábrala. Consulte la sección [Email delivery](../../automating/using/email-delivery.md) .
...
1. Cree la siguiente expresión utilizando la función **[!UICONTROL ToDateTime]** y el campo **[!UICONTROL Segment code]** . También puede escribir directamente en la expresión, pero asegúrese de utilizar la sintaxis y la ortografía correctas.
...
1. Defina cuatro segmentos. Para cada segmento:
   ...
   * Asegúrese de seleccionar la opción **[!UICONTROL Limit the population of this segment]** .
   * En la pestaña **[!UICONTROL Limitation]** , seleccione **[!UICONTROL Random sampling]** e introduzca el porcentaje deseado para cada segmento: **25**.
...
1. En el menú desplegable de optimización del tiempo de envío, seleccione **[!UICONTROL Send at a custom date defined by a formula]** y haga clic en el botón **[!UICONTROL Edit an expression]**.

   ![](assets/send-time_opt_formula_expression.png)

1. En **[!UICONTROL Expression editor]**, configure la fecha y los códigos de segmento para calcular los datos de cada cliente.
   ...
   Esto permite recuperar la fecha y la hora especificadas en el campo **[!UICONTROL Start sending from]**.
