...
La preparación corresponde al paso de calcular la población objetivo y generar el contenido del mensaje para cada perfil incluido en el objetivo. Una vez finalizada la preparación, los mensajes están listos para enviarse, ya sea inmediatamente o en [la fecha y hora programadas](../../sending/using/about-scheduling-messages.md).

1. Para empezar a preparar la entrega, haga clic en el botón **Preparación** situado en la barra de acciones.

   ![](assets/preparing_delivery_2.png)

1. La variable **[!UICONTROL Deployment]** El bloque muestra el progreso de la preparación y las estadísticas de preparación: número de mensajes dirigidos, número de mensajes que se van a enviar, etc.

   En función del tamaño de la población de destino, esta operación puede tardar algún tiempo.

   ![](assets/preparing_delivery.png)

1. Detenga la preparación en cualquier momento usando la función **Stop** , ubicado en la barra de acciones.
...
1. El mensaje se guarda automáticamente durante la fase de preparación para la entrega. Si necesita realizar cambios en la programación del mensaje después del paso de preparación, debe asegurarse de hacer clic en el botón **[!UICONTROL Prepare]** para que se tengan en cuenta estos cambios. Para obtener más información sobre cómo programar un mensaje, consulte esta [página](../../sending/using/about-scheduling-messages.md).
...
1. La variable **[!UICONTROL Deployment]** se abre la ventana, corrija los errores y reinicie la preparación.
