...
>[!NOTE]
>
>Microsoft Azure Directory asigna un ID de aplicación (cliente) único a la aplicación. Necesitará este ID más adelante al configurar Dynamics 365, así como al realizar la configuración de la herramienta de integración.
...
* [Comience con la ](../../integrating/using/d365-acs-self-service-app-quick-start-guide.md) aplicación de integración de autoservicio, que contiene la lista completa de pasos para que la integración se ponga en marcha.
