...
description: 'Obtenga información sobre cómo configurar la integración de servicios principales Audience Manager/Personas para compartir audiencias o segmentos con inicios con las distintas soluciones de Adobe Experience Cloud. '
...
El aprovisionamiento y la configuración del núcleo de Audience Manager y personas en Adobe Campaign realizan dos pasos: [Enviar la solicitud a Adobe](#submitting-request-to-adobe) y, a continuación, [configurar la integración en Adobe Campaign](#configuring-the-integration-in-adobe-campaign).
...
Primero necesitamos configurar o comprobar las cuentas externas en Adobe Campaign. Estas cuentas deberían haber sido configuradas por Adobe y se debería haber comunicado la información necesaria.
