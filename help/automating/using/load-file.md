...
La configuración de la actividad incluye dos pasos. En primer lugar, debe definir la estructura de archivos esperada cargando un archivo de muestra. Una vez hecho esto, puede especificar el origen del archivo cuyos datos se importarán.
...
1. Vaya a la **[!UICONTROL File structure]** ficha para ver la estructura que se detecta automáticamente desde el archivo de muestra.
...
El siguiente ejemplo muestra el resultado de una actividad de carga de archivos descargada automáticamente mediante una actividad de transferencia de archivos, seguida de una actividad de actualización de datos. Este flujo de trabajo tiene como objetivo enriquecer la base de datos de Adobe Campaign con nuevos perfiles o actualizar los perfiles existentes utilizando los datos recuperados del archivo importado.
...
1. Arrastre y suelte una **[!UICONTROL Query]** actividad en el flujo de trabajo y ábrala para definir el destino principal.
...
1. En la **[!UICONTROL Advanced relations]** ficha de la actividad de enriquecimiento, seleccione los campos **[!UICONTROL 0 or 1 cardinality simple link]** y defina los campos que se utilizarán para la reconciliación. Aquí utilizamos el apellido para reconciliar los datos con los perfiles de base de datos.

   ![](assets/load_file_enrichment_relation.png)

1. En la **[!UICONTROL Additional data]** ficha, seleccione los elementos que desee utilizar en el correo electrónico. Aquí seleccione Número de cuenta (columna del archivo que recuperó a través de la actividad de carga del archivo).
...
1. Arrastre y suelte una **[!UICONTROL Segmentation]** actividad en el flujo de trabajo y ábrala para reducir el objetivo principal.
...
1. Agregue un campo de personalización y seleccione los datos adicionales definidos en la actividad de enriquecimiento (aquí Número de cuenta) desde el **[!UICONTROL Additional data (targetData)]** nodo. Esto permite recuperar dinámicamente el número de cuenta de cada perfil en el contenido del correo electrónico.

   ![](assets/load_file_perso_field.png)

1. Guarde el correo electrónico e inicie el flujo de trabajo.

El correo electrónico se envía al destino. Cada perfil recibe el correo electrónico con su correspondiente número de cuenta.
