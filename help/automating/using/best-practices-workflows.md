...
>[!IMPORTANT]
>
>Incluso si no está alcanzando el umbral de 20 flujos de trabajo, Adobe le recomienda **extender la ejecución del flujo de trabajo con el paso del tiempo**. Escalonar la ejecución de los flujos de trabajo garantizará un mejor rendimiento de la instancia.
...
Para asegurarse de que el flujo de trabajo termina correctamente, evite dejar la última transición de un flujo de trabajo sola usando un **[!UICONTROL End activity]**.
