...
Las transiciones que siguen a actividades que procesan datos contienen poblaciones intermedias. Puede acceder a ellas si marca la opción **[!UICONTROL Keep interim results]** en la sección **[!UICONTROL Execution]** de las propiedades del flujo de trabajo.
...
Cuando se selecciona una actividad, aparecen acciones rápidas alrededor de la actividad, lo que le permite interactuar con ella. Por ejemplo, para configurar una actividad, selecciónela y ábrala con el botón ![](assets/edit_darkgrey-24px_table.png) en las acciones rápidas.
...
* Pulse **Enter** para ver los detalles de la actividad o transición seleccionada actualmente.
* Presione **Delete** para eliminar la actividad seleccionada actualmente.
...
<img height="21px" src="assets/pending_darkgrey-24px_table.png" /> **[!UICONTROL Immediate execution]**<br/>Fuerza el procesamiento inmediato de la selección. Este botón solo está disponible para las actividades <span class="uicontrol">Scheduler</span> y <span class="uicontrol">Wait</span>.
...
1. Seleccione la actividad y haga clic en el botón **[!UICONTROL Copy selection]** en las acciones rápidas.
   ...
   También puede utilizar el atajo de teclado **Ctrl + C**.

   ![](assets/wkf_copypaste1.png)

1. Haga clic con el botón derecho en el espacio de trabajo del flujo de trabajo de destino y, a continuación, haga clic en el botón **[!UICONTROL Paste]** .

   También puede utilizar el atajo de teclado **CTRL + V**.
