...
1. Haga clic con el botón secundario en el espacio de trabajo del flujo de trabajo de destinatario y, a continuación, haga clic en el **[!UICONTROL Paste]** botón.
