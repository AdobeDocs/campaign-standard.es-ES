...
* Una actividad [Leer audiencia](../../automating/using/read-audience.md) carga la audiencia de archivo creada en el flujo de trabajo de importación. Los datos de audiencia aún no están reconciliados con la base de datos de Adobe Campaign.
