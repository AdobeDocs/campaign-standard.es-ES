...
>[!CAUTION]
>
>A partir de la versión 20.3, los archivos descargados con la actividad **[!UICONTROL Transfer File]** se eliminarán después de X días, donde X se determina mediante el campo **[!UICONTROL History in days]** en el menú **[!UICONTROL Execution]** de las propiedades de flujo de trabajo.
...
1. La sección **[!UICONTROL Additional options]**, disponible en función del protocolo seleccionado, le permite añadir parámetros al protocolo. Se puede:
   ...
   * **[!UICONTROL List all files]**: esta opción está disponible al seleccionar la acción **[!UICONTROL File listing]** en la pestaña **[!UICONTROL General]**. Permite indexar todos los archivos presentes en el servidor en la variable de evento **vars.filenames** en la que los nombres de archivo están separados por los caracteres **&#39;n&#39;**.
...
Con este protocolo, puede elegir esta opción: **[!UICONTROL Use connection parameters defined in an external account]**. En este caso, seleccione la cuenta que desee y especifique la ruta del archivo que desea descargar.
...
Con este protocolo, puede elegir la opción **[!UICONTROL Use connection parameters defined in an external account]**, luego seleccionar la cuenta que desee y especificar la ruta del archivo que quiera descargar.
