...
1. Arrastre y suelte una [Envío de correo electrónico](../../automating/using/email-delivery.md) después de cada segmento.
...
1. En **[!UICONTROL Activities]** > **[!UICONTROL Execution]**, arrastre y suelte una [Espera](../../automating/using/wait.md) actividad.
...
1. Haga doble clic en la actividad.
1. En **[!UICONTROL Shortcuts]**, arrastrar y soltar **[!UICONTROL Tracking Logs]** y con el operador **[!UICONTROL exists]**.
1. En **[!UICONTROL Shortcuts]**> **[!UICONTROL Delivery]**, arrastrar y soltar **[!UICONTROL delivery]** con el operador **[!UICONTROL is equal to]** y seleccione la entrega como valor.
1. En **[!UICONTROL Shortcuts]**> **[!UICONTROL Delivery]**, arrastrar y soltar **[!UICONTROL type]** y compruebe **[!UICONTROL Open]** como valor.
...
Para obtener más información, consulte [Diseño de un sms](../../channels/using/creating-an-sms-message.md) para obtener más información.
1. Haga clic en **[!UICONTROL Preview]** para comprobar el diseño.
1. Haga clic en **[!UICONTROL Save]**.
