...
Están configurados en [asignaciones de destino](../../administration/using/target-mappings-in-campaign.md)y se definen al crear un flujo de trabajo, en la variable **[!UICONTROL Properties]** de una actividad Query .
