...
seo-description: Aquí puede encontrar la lista de todos los componentes disponibles en los informes dinámicos, así como sus definiciones.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> Gender<br /> </td> 
   <td> Sexo del destinatario como hombre o mujer. If the gender field is empty in the recipient's profile, the value will be none.<br /> </td> 
  </tr> 
  <tr> 
...
Las tablas siguientes proporcionan la lista de métricas utilizadas en los informes y sus definiciones según el tipo de entrega.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> Haga clic<br /> </td> 
   <td> Número de veces que el usuario ha entregado una notificación Push y ha hecho clic en el mismo. The user either wanted to view the notification, which will then be moved to Push Open tracking, or dismiss it.<br /> </td> 
  </tr> 
  <tr> 
   <td> Click through rate<br /> </td> 
  ...
  <tr> 
   ...
   <td> Número de veces que se ha entregado una notificación Push al dispositivo y se ha dejado intacta en el centro de notificaciones. En la mayoría de los casos, el número de impresiones debe ser similar al número entregado. This ensures that the device got the message and relayed that information back to the server.<br /> </td> 
  </tr> 
  <tr> 
   <td> Processed/sent<br /> </td> 
  ...
  <tr> 
   <td> Open<br /> </td> 
   <td> La cantidad total de notificaciones push enviadas al dispositivo y en las que los usuarios hicieron clic, abriendo así la aplicación. This is similar to the Push Click except a Push Open will not be triggered if the notification was dismissed.<br /> </td> 
  </tr> 
  <tr> 
   <td> Open rate<br /> </td> 
...
La tabla siguiente proporciona la lista de segmentos utilizados en los informes y sus definiciones.
