...
Para contar todos los servicios que tienen un valor **messageType** igual a "sms", realice una solicitud GET con el filtro **byChannel** .
...
Realice una solicitud GET en la dirección URL del nodo de **recuento** para recuperar el número de resultados.
