...
Puede crear un mensaje de correo electrónico [que comience de nuevo en Email Designer](#without-existing-content):
...
>[!NOTE]
>
>En ambas estrategias de creación, es fundamental completar la línea de asunto antes de enviar el correo electrónico. Obtenga información sobre cómo [Añadir una línea de asunto](#add-a-subject-line).
...
1. Vaya a la ficha **[!UICONTROL Properties]** de la página de inicio de Email Designer (a la que se puede acceder desde el icono de inicio) y rellene la sección **[!UICONTROL Subject]**.
...
* **HTML**
   ...
   Si está familiarizado con HTML, puede copiar y pegar el código HTML del pie de página original utilizando el componente de contenido **[!UICONTROL Html]**. Para obtener más información sobre esto, consulte [Acerca de los componentes de contenido](../../designing/using/designing-from-scratch.md#about-content-components).
...
1. Ajuste **margen** según sus necesidades.
1. Haga clic en **Save**.
...
### Generación de contenido a partir de una plantilla lista para usar {#building-content-from-an-out-of-the-box-template}
...
1. Vaya a la ficha **[!UICONTROL Properties]** de la página de inicio de Email Designer (a la que se puede acceder desde el icono de inicio) y rellene la sección **[!UICONTROL Subject]**.
1. Puede combinar estos elementos para crear una serie de variantes de correo electrónico. Por ejemplo, puede realizar el duplicado de una sección de correo electrónico seleccionando un componente de estructura y haciendo clic **[!UICONTROL Duplicate]** en la barra de herramientas contextual.
...
Este caso de uso oferta una forma rápida de convertir el correo electrónico HTML en componentes de Email Designer. Para obtener más información sobre este tema, consulte [Conversión de contenido HTML](../../designing/using/using-existing-content.md#converting-an-html-content).
