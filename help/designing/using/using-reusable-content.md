...
description: Comience a crear contenido de correo electrónico reutilizable con Email Designer.
audience: designing
...
Obtenga información sobre cómo dominar la edición de contenido de correo electrónico. Con Email Designer, puede crear plantillas y fragmentos con su propio contenido predefinido y reutilizarlos para las siguientes entregas.

## Diseño de correos electrónicos con plantillas {#designing-templates}

>[!NOTE]
>
> En Adobe Campaign Standard, puede crear diferentes tipos de plantillas a las que se puede acceder desde el menú **Recursos** > **Plantillas**. Las plantillas utilizadas en el Designer de correo electrónico son plantillas de contenido. Para obtener más información, consulte [Acerca de las plantillas](../../start/using/marketing-activity-templates.md).
...
Al editar contenido con Email Designer, también puede crear plantillas de contenido guardando el contenido como fragmento o plantilla. Para obtener más información, consulte [Guardar contenido como plantilla](#saving-content-as-template) y [Guardar contenido como fragmento](../../designing/using/using-reusable-content.md#saving-content-as-a-fragment).

**Temas relacionados:**

* Para obtener más información sobre la edición de contenido, consulte [Acerca del diseño del contenido del correo electrónico](../../designing/using/designing-content-in-adobe-campaign.md).
...
1. Haga clic en la etiqueta de correo electrónico para acceder a la pestaña **[!UICONTROL Properties]** de la Designer de correo electrónico.
1. Especifique una etiqueta reconocible y seleccione los siguientes parámetros para poder utilizar esta plantilla en los correos electrónicos:
   ...
   * Seleccione **[!UICONTROL Shared]** o **[!UICONTROL Delivery]** de la lista desplegable **[!UICONTROL Content type]**.
   * Seleccione **[!UICONTROL Template]** de la lista desplegable **[!UICONTROL HTML type]**.
...
1. Si es necesario, puede establecer una imagen que se utilizará como miniatura para la plantilla. Selecciónelo en la ficha **[!UICONTROL Thumbnail]** de las propiedades de la plantilla.
   ...
   Esta miniatura se mostrará en la pestaña **[!UICONTROL Templates]** de la página de inicio de [Designer de correo electrónico](../../designing/using/designing-content-in-adobe-campaign.md).

1. Cierre la ficha **[!UICONTROL Properties]** para volver al área de trabajo principal.
...
Esta plantilla ahora se puede utilizar en cualquier correo electrónico creado con Email Designer. Selecciónelo en la ficha **[!UICONTROL Templates]** de la página de inicio de [Email Designer](../../designing/using/designing-content-in-adobe-campaign.md).
...
1. Agregue una etiqueta y una descripción si es necesario y luego haga clic en **[!UICONTROL Save]**.
...
1. Para usar tu nueva plantilla, selecciónela en la pestaña **[!UICONTROL Templates]** de la página de inicio de [Email Designer](../../designing/using/designing-content-in-adobe-campaign.md).

   ![](assets/content_template_new.png)

### Creación de una plantilla con fragmentos y componentes {#template-fragments-components}

Ahora puede crear una plantilla de correo electrónico con el Designer de correo electrónico. Utilice los componentes de contenido para reflejar las diferentes secciones del correo electrónico y ajustar la configuración para que sean lo más parecidas posible al boletín informativo original. Finalmente, inserte los fragmentos que acaba de crear.

1. Con Email Designer, cree una plantilla. Para obtener más información, consulte [Plantillas de contenido](#content-templates).
1. Inserte varios componentes de estructura en la plantilla, correspondientes al encabezado, pie de página y cuerpo del correo electrónico. Para obtener más información sobre cómo agregar componentes de estructura, consulte [Edición de la estructura de correo electrónico con el Designer de correo electrónico](../../designing/using/designing-from-scratch.md#defining-the-email-structure).
...
1. Ajuste al máximo los componentes de contenido para que coincidan con el correo electrónico original.
   ...
   Para obtener más información sobre la administración de la configuración de estilos y los atributos en línea, consulte [Edición de estilos de correo electrónico](../../designing/using/styles.md).
...
Ahora puede administrar completamente esta plantilla dentro de Email Designer para crear y actualizar el boletín informativo que enviará cada mes a sus destinatarios.
...
* [Vídeo de introducción a Email Designer](../../designing/using/designing-content-in-adobe-campaign.md#video)
...
Se pueden encontrar en la interfaz en **Recursos** > **Fragmentos de contenido y plantillas**.

Para sacar el máximo partido a los fragmentos de correo electrónico en Designer:

* Cree sus propios fragmentos. Ver [Crear un fragmento de contenido](#creating-a-content-fragment) y [Guardar contenido como un fragmento](#saving-content-as-a-fragment).
* Utilícelos tantas veces como sea necesario en sus correos electrónicos. Ver [Inserción de elementos en un correo electrónico](#inserting-elements-into-an-email).
...
Ese fragmento se convierte en un componente independiente que ya no está vinculado al fragmento original. Luego se puede editar como cualquier otro componente de contenido. Ver [Acerca de los componentes de contenido](../../designing/using/designing-from-scratch.md#about-content-components).
...
1. Para acceder a los elementos de contenido, seleccione el icono **+** de la izquierda. Seleccione [Fragmentos](#about-fragments) o [Componentes de contenido](../../designing/using/designing-from-scratch.md#about-content-components).
...
1. Especifique una etiqueta reconocible y seleccione los siguientes parámetros para buscar el fragmento al editar el contenido del correo electrónico:
   ...
   * Como los fragmentos solo son compatibles con los correos electrónicos, seleccione **[!UICONTROL Delivery]** de la lista desplegable **[!UICONTROL Content type]**.
   * Seleccione **[!UICONTROL Fragment]** de la lista desplegable **[!UICONTROL HTML type]** para poder usar este contenido como un fragmento.
...
Este fragmento ahora se puede utilizar en cualquier correo electrónico creado con Email Designer. Aparece en la sección **[!UICONTROL Fragments]** de la paleta.

>[!NOTE]
>
>No puede insertar campos de personalización dentro de un fragmento a menos que se utilice en un correo electrónico y esté desbloqueado. Ver [Acerca de los fragmentos](#about-fragments).

### Guardar contenido como fragmento {#saving-content-as-a-fragment}

Al editar un correo electrónico con la Designer de correo electrónico, puede guardar directamente parte de ese correo electrónico como un fragmento.
...
1. Al editar un correo electrónico en el Designer de correo electrónico, seleccione **[!UICONTROL Save as fragment]** en la barra de herramientas principal.
...
Con Email Designer, cree un fragmento para cada sección reutilizable. En este ejemplo, creará dos fragmentos: uno para el encabezado y otro para el pie de página. A continuación, puede copiar las partes relevantes del contenido existente en estos fragmentos.
