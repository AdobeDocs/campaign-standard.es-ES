...
* **[!UICONTROL Transactional messages]**, que contiene los submenús **[!UICONTROL Deliveries]** y **[!UICONTROL Event configuration]**: para más información, consulte la sección [Mensajes transaccionales](../../channels/using/about-transactional-messaging.md).
