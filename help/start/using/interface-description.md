...
description: 'Obtenga información sobre cómo navegar y utilizar el espacio de trabajo de Adobe Campaign: página de inicio, barra superior, menús avanzados y barras de acción.'
audience: start
...
* La tarjeta **[!UICONTROL Create a Direct mail]** lleva al asistente de creación de correo directo. Consulte la sección [Creación de un correo directo](../../channels/using/creating-the-direct-mail.md).
...
* La tarjeta **[!UICONTROL Create an In-App message]** le lleva al asistente de creación en la aplicación. Este asistente le permite seleccionar el tipo de mensaje en la aplicación que desea crear, definir sus propiedades, audiencia y contenido. Consulte la sección [Creación de un mensaje en la aplicación](../../channels/using/about-in-app-messaging.md).
* La tarjeta **[!UICONTROL Marketing activities]** lleva a la lista completa de todas las actividades, programas y campañas, particularmente correos electrónicos, SMS, flujos de trabajo y páginas de destino. Desde aquí puede filtrar los elementos buscando por nombre, fecha, estado o tipo de actividad. Para obtener más información, consulte la sección [Lista de actividades de marketing](../../start/using/marketing-activities.md#about-marketing-activities).
...
* La tarjeta **[!UICONTROL Audiences]** lleva directamente a la lista de públicos. Desde aquí puede acceder a públicos existentes y crear otros nuevos. Consulte [Administración de públicos](../../audiences/using/about-audiences.md).
...
* El logotipo de **Adobe** en la esquina superior izquierda de la página te da acceso a las funciones y configuraciones avanzadas. Los menús dependen del perfil y los permisos.
...
* El icono **[!UICONTROL Help]** se describe [debajo de](#help).
* El icono **Notificaciones** muestra la información o las alertas más recientes.
* El icono **Usuario** le permite ver información vinculada a su perfil. Use este icono si necesita **[!UICONTROL Sign out]**.
...
1. La pestaña **[!UICONTROL Help]** contiene:
   ...
   * un vínculo **[!UICONTROL Community]** para acceder al foro dedicado a sus preguntas en Campaign.
   * un acceso directo a: Centro de ayuda, Servicio de atención al cliente, Estado del producto de Experience Cloud, Conexión de desarrolladores, Notas de la versión, Planificación de versiones y la pantalla de **[!UICONTROL About]**.
1. La ficha **[!UICONTROL Support]** le permite abrir un caso de soporte técnico y ponerse en contacto con nosotros por teléfono o X (anteriormente conocido como Twitter).
1. La ficha **[!UICONTROL Feedback]** le facilita informar sobre problemas o compartir sus ideas.
...
* **[!UICONTROL Audiences]**: para obtener más información, consulte la sección [Administración de públicos](../../audiences/using/about-audiences.md).
...
* Una **lista** que presenta varios elementos, tales como programas, campañas, perfiles, etc. Estos elementos se pueden ver en modo **[!UICONTROL Card]** o **[!UICONTROL List]**. Utilice el botón Cambiar modo para cambiar de uno a otro. Cada elemento muestra indicadores.
...
* Un **panel de control** que presenta una visión general de todos los parámetros vinculados a una actividad. Esta pantalla incluye zonas interactivas que permiten separar y configurar los distintos conceptos de forma independiente.
...
* Para obtener más información sobre las acciones relacionadas con las pantallas de **panel de control**, consulte la sección [Panel de control de mensajes](../../channels/using/message-dashboard.md).
