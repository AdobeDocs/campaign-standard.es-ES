...
* El logotipo de **Adobe** en la esquina superior izquierda de la página le da acceso a las funciones y configuraciones avanzadas. Los menús dependen del perfil y los permisos.
...
1. La pestaña **[!UICONTROL Help]** contiene:
   ...
   * un acceso directo a: Centro de ayuda, Servicio de atención al cliente, Estado del producto del Experience Cloud, Conexión de desarrolladores, Notas de la versión, Planificación de versiones y la pantalla **[!UICONTROL About]**.
