...
¿Busca una versión específica de Adobe Campaign Standard para el período 2015-2016?
...
* Se ha corregido un problema que provocaba que se mostrara un mensaje de error al acceder al **[!UICONTROL Hot Clicks]**informe en un correo electrónico de prueba A/B.
...
* Se ha corregido un problema que podía provocar que se mostrara un error al usar la opción **Imagen compartida desde Adobe Marketing Cloud** en un mensaje de correo electrónico.

_Recursos personalizados_

* Las API mejoradas previsualizan el registro entre dos publicaciones de campos de API extendidos.
...
* Esta versión incorpora nuevas funciones de filtrado y búsqueda en las listas de la interfaz. Esta nueva función está disponible, por ejemplo, en los registros (entrega, seguimiento), servicios (suscripción, historial de suscripciones), audiencias y transiciones de flujo de trabajo.
...
_Editor de contenido_

* El editor de contenido ahora le permite personalizar cualquier dirección URL contenida en un correo electrónico o una página de aterrizaje. Consulte la documentación [detallada](../../designing/using/personalization.md#personalizing-urls).
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> La actividad de <span class="uicontrol">segmentación</span> ahora permite al usuario segmentar los datos de un recurso temporal. Por ejemplo: los datos de un archivo importado.<br /><a href="../../automating/using/segmentation.md"> Para obtener más información, consulte la documentación detallada</a>.<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
* Se corrigió un error de recuento que se podía causar al agregar una condición adicional en una consulta, después de haber modificado la dimensión de filtrado.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Algunas acciones aparecen al pasar el ratón sobre un elemento de una lista o un flujo de trabajo o después de seleccionarlo. Algunas de estas acciones ahora se muestran como iconos alrededor de los elementos en cuestión para facilitar el acceso. Estas acciones rápidas se pueden utilizar para duplicar un elemento, eliminarlo, mostrar los detalles, etc.<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
* Se ha corregido un error que podía impedir que la **[!UICONTROL Load file]**actividad funcionara correctamente. A continuación, aparecerá un mensaje de error en blanco.
...
* Se ha corregido un error que podía provocar un retraso de 15 minutos para que se escribieran determinados registros.
...
* Se ha corregido un error que podía impedir que los mensajes de correo electrónico se enviaran desde un flujo de trabajo.
  ...
  <tr> 
   ...
   <td> Ahora puede compartir audiencias entre Adobe Campaign y otras soluciones de Adobe Marketing Cloud:<br /> 
    <ul> 
     ...
     <li> Importar: al crear una audiencia de tipo <strong>Lista</strong> desde la pantalla de gestión de público, una nueva opción le permite identificarla como una audiencia <span class="uicontrol">de</span> Adobe Marketing Cloud. A continuación, puede seleccionar una audiencia compartida existente para importarla a Adobe Campaign. </li> 
...
_Servicio principal de recursos_
