...
Ya está disponible la nueva integración de Campaign Standard - Microsoft Dynamics 365. [Más información](../../integrating/using/working-with-campaign-standard-and-microsoft-dynamics-365.md)
...
La documentación del Diseñador de correos electrónicos de Campaign y las páginas relacionadas se han actualizado para indicar que el SDK de Adobe Creative ha quedado obsoleto. [Más información](https://helpx.adobe.com/es/campaign/kb/acs-deprecated-and-removed-features.html)
...
La guía de introducción a la creación de un correo electrónico personalizado se ha movido y actualizado. [Más información](https://helpx.adobe.com/es/campaign/kb/acs-get-started-with-emails.html)
...
California Consumer Privacy Act (CCPA): [Más información](https://helpx.adobe.com/es/content/help/en/campaign/kb/acs-privacy.html#ccpa)
...
Se ha añadido un nuevo ejemplo que muestra cómo enviar un correo electrónico que contiene datos adicionales recuperados de una actividad de carga de archivo. [Más información](../../automating/using/load-file.md#example-2-email-with-enriched-fields)
...
Se ha añadido un nuevo artículo de ayuda con información relacionada con la administración de subdominios y certificados dentro del Panel de control. [Más información](https://docs.adobe.com/content/help/es-ES/control-panel/using/subdomains-and-certificates/subdomains-branding.html)
...
Se ha añadido una tabla de compatibilidad de creación de informes dinámicos para comprender mejor la compatibilidad entre dimensiones y métricas. [Más información](https://docs.campaign.adobe.com/doc/standard/en/Technotes/dynamic_report_compatibility.pdf)
...
Se ha añadido una nueva nota técnica sobre cómo mostrar una imagen desde una notificación push de Adobe Campaign Standard. [Más información](https://helpx.adobe.com/es/content/help/en/campaign/kb/display-image-push.html)

Se ha añadido una nueva nota técnica sobre la implementación del seguimiento push. [Más información](https://helpx.adobe.com/es/content/help/en/campaign/kb/push-tracking.html)
...
Se ha añadido información sobre la nueva opción de las actividades de consulta ([más información](../../automating/using/query.md)) y segmentación ([más información](../../automating/using/segmentation.md)), que permite añadir una transición saliente después de la actividad si no recupera ningún dato.
...
Los vídeos se han actualizado y movido [aquí](https://docs.adobe.com/content/help/es-ES/campaign-standard-learn/tutorials/overview.translate.html).
...
Se ha añadido un ejemplo en la sección de actividad de consultas sobre cómo dirigir perfiles que hicieron clic en un enlace específico de una entrega. [Más información](../../automating/using/query.md#targeting-profiles-who-clicked-a-specific-link-)
...
La sección dedicada a las  de lista de bloqueados ha pasado a llamarse &quot;Explicación de los procesos de inclusión y exclusión&quot;. Se ha actualizado con información sobre cómo administrar la inclusión en canales específicos y cómo configurar páginas de aterrizaje para administrar la inclusión y la exclusión. [Más información](../../audiences/using/about-opt-in-and-opt-out-in-campaign.md)
...
Se añadió información sobre cómo configurar páginas de aterrizaje para que sus destinatarios puedan ser incluida en la lista de bloqueados. [Más información](../../audiences/using/managing-opt-in-and-opt-out-in-campaign.md)
...
Ya está disponible una nueva opción que permite obtener rendimiento al definir muchos datos adicionales en una **[!UICONTROL Query]**. [Más información](../../automating/using/query.md)
...
Se ha eliminado la sección que incluye la lista de autorizaciones. [Más información](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf) (PDF).
...
Nueva sección dedicada a lista de bloqueados administración de . [Más información](../../audiences/using/about-opt-in-and-opt-out-in-campaign.md)
...
Se han actualizado las instrucciones para configurar la integración con Audience Manager o el servicio principal People. [Más información](../../integrating/using/provisioning-and-configuring-integration-with-audience-manager-or-people-core-service.md)
...
Se ha revisado la tabla de autorizaciones para que el uso de ciertas funciones sea más claro. [Más información](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf)
...
Integración de Dreamweaver (Labs): [Más información](https://docs.adobe.com/content/help/es-ES/campaign-standard-learn/tutorials/designing-content/email-designer/dreamweaver-integration.translate.html)
