...
* El tamaño máximo de un correo electrónico ahora es 100 MB de forma predeterminada. Este límite permite evitar cualquier error que pueda aumentar indefinidamente el tamaño de un correo electrónico, lo que puede bloquear el sistema. (CAMP-47445)
...
* Se ha corregido un problema por el que faltaban registros de seguimiento en algunas instancias. Se ha añadido un nuevo flujo de trabajo técnico (**trackingLogRecovery**) para restaurar estos registros de seguimiento perdidos y solo debe utilizarlo el personal interno de Adobe.
...
* Se ha corregido un problema por el cual los informes no se recibían después de usar la opción **Enviar informe programado**. (CAMP-48583)
...
* Se ha corregido un problema con la opción **Enviar informe programado** en el informe Dynamics en el que el flujo de trabajo integrado **Compartición instantánea de informe** (reportSendingNow) no generaba informes. (CAMP-47786)
