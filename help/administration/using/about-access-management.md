...
Los usuarios se administran en Admin Console. Obtenga más información en la sección [Administración de grupos y usuarios](../../administration/using/managing-groups-and-users.md) y en la [documentación de Admin Console](https://helpx.adobe.com/es/enterprise/admin-guide.html).
