...
description: Administración de usuarios y permisos de Discover, pautas de supervisión, configuraciones específicas de canal y pautas de configuración de aplicaciones.
