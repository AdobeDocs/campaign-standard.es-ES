...
>[!NOTE]
>
>Algunos parámetros solo están disponibles en plantillas. Parameters you can access [depend on your permissions](../../administration/using/types-of-users.md).
...
* **[!UICONTROL Compute the label during delivery analysis]**: permite calcular el valor de etiqueta del correo electrónico durante la fase de preparación de los mensajes.
