...
# Enriqueciendo la base de datos{#enriching-the-database}
...
Los flujos de trabajo le permiten recopilar datos e importarlos a la base de datos de Campañas mediante el uso de actividades [[!UICONTROL Data management]](../../automating/using/about-data-management-activities.md).
