...
1. Introduzca una etiqueta, seleccione una dimensión de segmentación y haga clic en **[!UICONTROL Create]**.
   ...
   Los pasos de configuración se presentan en la sección [Configuración de un evento transaccional](../../channels/using/configuring-transactional-event.md).
...
1. Haga clic en la sección **[!UICONTROL Content]** y seleccione una plantilla de correo electrónico. Para obtener más información sobre cómo editar contenido de mensaje transaccional, consulte [Edición de mensajes transaccionales](../../channels/using/editing-transactional-message.md).
