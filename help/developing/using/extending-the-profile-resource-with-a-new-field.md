...
Queremos actualizar nuestros perfiles con el nuevo campo usando una página de destino y, luego, dirigiéndonos a destinatarios con una newsletter específica según sus intereses.
...
Para actualizar perfiles con datos para el nuevo campo personalizado, puede crear una página de destino con la plantilla **[!UICONTROL Profile acquisition]**. Para obtener más información sobre las páginas de destino, consulte esta [página](../../channels/using/getting-started-with-landing-pages.md).
...
Primero, necesitamos crear una página de destino que actualice los campos **Intereses** de los perfiles objetivo:

1. En **[!UICONTROL Marketing activities]**, haga clic en **[!UICONTROL Create]** y seleccione **[!UICONTROL Landing page]**.
1. Seleccione un tipo de página de destino. Dado que queremos actualizar nuestros perfiles, seleccione **[!UICONTROL Profile acquisition]**.
1. Haga clic en **[!UICONTROL Create]**.
1. Haga clic en el bloque **[!UICONTROL Content]** para editar en inicio el contenido de la página de destino.

   ![](assets/schema_extension_uc21.png)

1. Personalice la página de destino según sea necesario.
...
1. Guarde la página de destino y pruébela para comprobar que los campos están correctamente configurados.
1. Haga clic en **[!UICONTROL Publish]** cuando la página de destino esté lista.

Su página de destino ya estará lista. Para actualizar los perfiles, puede crear un flujo de trabajo que enviará una oferta especial en función del interés seleccionado.

1. En la pestaña **[!UICONTROL Marketing activities]**, haga clic en **[!UICONTROL Create]** y seleccione **[!UICONTROL Workflow]**.
1. Arrastre y suelte una actividad **[!UICONTROL Query]** para dirigirse a los perfiles o los públicos que necesite.
1. Arrastre y suelte una actividad **[!UICONTROL Email delivery]** para empezar a configurar el correo electrónico, que contendrá un vínculo a la página de destino. Seleccione el **[!UICONTROL Add an outbound transition with the population]**.
...
1. Añada un botón en el correo electrónico que redirija los perfiles a su página de destino.
...
1. En la ventana **[!UICONTROL Insert link]**, seleccione **[!UICONTROL Landing page]** en la lista desplegable **[!UICONTROL Link type]** y, a continuación, seleccione la página de destino creada anteriormente.

   ![](assets/schema_extension_uc24.png)

1. Haga clic **[!UICONTROL Save]**. El correo electrónico ya estará listo, por lo que puede volver al flujo de trabajo.
1. Añada una actividad **[!UICONTROL Wait]** para que sus perfiles puedan rellenar la página de destino.
